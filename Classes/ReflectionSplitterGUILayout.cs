...
{
	internal static class ReflectionSplitterGUILayout
	{
		...
		public static void DrawHorizontalSplitter2(Rect rect = default, Color color = default, float thickness = 1.5f)
		{
